...
angular.module('ludecolApp')
    .factory('Auth', function Auth($rootScope, $state, $q, $translate, Principal, AuthServerProvider, Account, Register, Activate, Password, NotificationService, ObjectiveService) {
        return {
