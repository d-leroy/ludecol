...
function ludecolendParamsAsArray() {
  assertEquals('http://foo.com?q=1&r=2&s=3&s=4#preserve',
      utils.appendParams('http://foo.com#preserve',
          ['q', 1, 'r', 2, 's', [3, 4]]));
...
function ludecolendParamEscapes() {
...
function ludecolendParamsFromMap() {
